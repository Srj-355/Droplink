...
const s = {
  ...
  name: { fontSize: "0.72rem", color: "#334155", flex: 1, minWidth: 80, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" },
  size: { fontSize: "0.62rem", color: "#64748b", flexShrink: 0 },
  removeBtn: {
