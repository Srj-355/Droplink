...
// const s = {
//   item: { borderRadius: 12, padding: "0.75rem 0.9rem", transition: "box-shadow 0.15s" },
//   top: { display: "flex", alignItems: "center", gap: "0.4rem", marginBottom: "0.45rem" },
...
//   foot: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "0.5rem" },
...
const s = {
  item: { borderRadius: 12, padding: "0.75rem 0.9rem", transition: "box-shadow 0.15s", overflow: "hidden", minWidth: 0 },
